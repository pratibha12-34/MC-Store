...
const dashboard = () => {
  return (
    ...
    <div className="flex flex-row justify-center m-20 gap-10 h-4/5 scroll-behaviour">
      ...
      <Link href="/store">   <div className="m-5 flex flex-col justify-center items-center w-10/12 h-6 text-xl gap-8 hover:text-2xl duration-300 cursor-pointer transition-all">Store</div></Link>
      ...
      <div className="px-10 py-5 h-full w-full text-xl pt-80">
